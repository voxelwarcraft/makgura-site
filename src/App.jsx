...
const nftCards = [
  { title: "Capital City Deeds", text: "Permanent tradable NFT deeds tied to major cities. Owners only earn and govern when their faction actually controls the city." },
  { title: "Housing Ownership", text: "NFT-owned, earned, or rented homes provide prestige, location value, and safe storage without adding combat stats." },
  { title: "Prestige Collectibles", text: "Future Makgura NFTs can support cosmetics, banners, titles, and rare visual identity for clans, Gladiators, and governors." },
  { title: "Not Pay-To-Win", text: "Makgura NFTs are designed around ownership, prestige, and economy rights. They do not sell weapons, stats, or direct battlefield strength." },
];
const eventCards = [
...
export default function App() {
  ...
  return <div className="site-shell"><PremiumEffects /><div className="site-bg" /><div className="site-grid" />
    ...
    <section id="nfts" className="section"><div className="container"><SectionHeading eyebrow="NFT OWNERSHIP" title="NFTs create ownership and prestige, not instant power." text="Like Ujura, Makgura treats NFTs as scarce ownership layers. Capital City deeds, housing, cosmetics, and prestige collectibles can matter economically and socially, but players still need gameplay, faction control, risk, and PvP performance to win."/><div className="four-grid">{nftCards.map((card)=><Card key={card.title} title={card.title} text={card.text} compact/>)}</div></div></section>
