export const defaultControlState = {
  ...
  "makgura": {
    ...
    "hero": {
      ...
      "body": "A persistent, player-driven war MMO where players level from 1-60, fight for Rome, the Barbarian Horde, or Egypt, capture cities, control territory, and compete over dynamic world resources.",
      "primaryCta": {
    ...
    "alpha": {
      ...
      "body": "Players level, fight, lose gear, control territory, govern cities, compete over dynamic resources, and reshape a constantly shifting ancient world.",
      ...
      "posts": [
        {
          ...
          "excerpt": "Makgura connects leveling, faction war, city control, loot risk, banks, housing, and world events into one ancient war MMO loop.",
          "seoTitle": "Risk, territory, and recovery define Makgura",
          "seoDescription": "Makgura connects leveling, faction war, city control, loot risk, banks, housing, and world events into one ancient war MMO loop.",
          "body": "Makgura is built around a simple promise: the world should remember what players do. Leveling, faction choice, death risk, city control, resource conflict, safe storage, and recovery systems all connect so war has weight without permanently trapping players after a loss.",
          "author": "Makgura Team",
          "publishedAt": "2026-05-04",
          "imageStyle": "radial-gradient(circle at 50% 10%, rgba(240,179,91,.62), transparent 22%), radial-gradient(circle at 18% 65%, rgba(193,72,35,.30), transparent 28%), linear-gradient(135deg, #1a0d09 0%, #321b0f 45%, #070606 100%)",
          "imageUrl": ""
